...
export default function TeamNotificationsIndex({
    notifications,
    filters,
    types,
    unreadCount,
    ...
    const applyFilters = () => {
        ...
        router.get('/team/notifications', Object.fromEntries(params));
    };
    ...
    const markAllAsRead = async () => {
        try {
            await axios.patch('/team/notifications/mark-all-read');
    ...
    const confirmDelete = async (notificationId: number) => {
        try {
            await axios.delete(`/team/notifications/${notificationId}`);
            router.reload({ only: ['notifications', 'unreadCount'] });
                        ...
                        <div className="flex flex-col gap-4 px-4 py-4 md:gap-6 md:py-6 lg:px-6">
                            <div>
                                ...
                                <p className="text-muted-foreground">
                                    Manage your team notifications and member updates
                                </p>
                            </div>
